...
request = function()
	...
	f:close()                                                    
	-- trigger execution
    cmd="./client -p 8888 -s localhost -i scripts/sgx_auth.lua -n 3 -m scripts/wrk.lua -m out -m scripts/dkjson.lua > xd1; cat xd1"
...
response = function(status, headers, body)
    ...
    f:write(json.encode(a, {indent=true}))
    f:close()
    cmd="./client -p 8888 -s localhost -i scripts/sgx_auth2.lua -n 3 -m scripts/wrk.lua -m out -m scripts/dkjson.lua > xd1; cat xd1"
