...
int lua_vm (int argc, char **argv) {
  ...
  clock_gettime(CLOCK_REALTIME, &t2);
    double tn;
    tn = get_time_diff(t2, t1) / 1000000000;   
    /* E2E means from the start of main to the end of code */
    fprintf(stdout, "LUA E2E    Time: %f\n", tn);
	//fprintf(stdout, "Freeed = %zd\n", freeed);
  return (result && status == LUA_OK) ? EXIT_SUCCESS : EXIT_FAILURE;
}



int main (int argc, char **argv) { return lua_vm(argc, argv);}

//int lua_main (int argc, char **argv) {
//    return lua_vm(argc, argv);
//}
